 ...
 * 
 */
public class Sequencer extends UnicastRemoteObject implements
		SequencerRemoteInterface {
	...
	public synchronized void forwardMessage(Message msg) {
		...
		System.out.println("Message #" + ordMsg.sequenceNumber + " from "
				+ ordMsg.processId + " forwarded to replicas.");
	}
